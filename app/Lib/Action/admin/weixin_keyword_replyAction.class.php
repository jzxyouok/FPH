<?php
class weixin_keyword_replyAction extends backendAction
{
    public function _initialize() {
        parent::_initialize();
        $this->_mod = D('weixin_keyword_reply');
    }
    ...
    protected function _search() {
        ...
        ($keyword = $this->_request('keyword', 'trim')) && $map['keyword'] = array('like', '%'.$keyword.'%');
		if($status!=''){
			$map['status'] = $status;
		}
		if($tid!=''){
