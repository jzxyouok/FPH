...
class passport
{
     ...
     * 注册新用户 //注册修改chl
     */
    public function register($username, $password, $mobile, $stores_id, $origin, $city_id) {
        if (!$add_data = $this->_us->register($username, $password, $mobile, $stores_id, $origin, $city_id)) {
